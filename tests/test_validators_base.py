...
def test_validate_token_as_int_with_invalid_token_returns_false():
...
def test_validate_token_as_int_with_invalid_base_returns_false(mock_int):
...
def test_validate_token_as_float_with_invalid_token_returns_false():
...
def test_validate_token_as_float_with_complex_number_returns_false():
...
def test_validate_token_as_float_with_valid_float_returns_true():
