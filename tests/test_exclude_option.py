...
class TestExcludeOption:
    """Test the fds-exclude configuration option."""

    def test_add_options_adds_fds_exclude_option(self):
    ...
    def test_parse_options_with_valid_exclude_list(self):
    ...
    def test_parse_options_with_empty_exclude_list(self):
    ...
    def test_parse_options_with_invalid_exclude_list(self):
    ...
    def test_parse_options_with_whitespace_in_exclude_list(self):
    ...
    def test_should_exclude_number_with_excluded_integer(self):
    ...
    def test_should_exclude_number_with_non_excluded_integer(self):
    ...
    def test_should_exclude_number_with_excluded_float(self):
    ...
    def test_should_exclude_number_with_non_whole_float(self):
    ...
    def test_should_exclude_number_with_invalid_token(self):
    ...
    def test_should_exclude_number_without_token_attribute(self):
    ...
    def test_process_number_token_excludes_excluded_numbers(self):
...
class TestExcludeOptionIntegration:
    """Integration tests for the fds-exclude option."""
